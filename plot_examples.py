...
if __name__ == "__main__":
    ...
    plot(partial(digit_plot, index=0), title="First Digit Distribution Height")
    plot(partial(digit_barplot, index=0), title="First Digit Distribution Height")
    plot(partial(digit_plot, index=1), title="Second Digit Distribution Height")
    plot(partial(digit_barplot, index=1), title="Second Digit Distribution Height")
